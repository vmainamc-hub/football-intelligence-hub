              ...
              {q.data.map((r) => (
                ...
                >
                  ...
                  <div className="mt-4 border-t border-border pt-3 text-xs text-muted-foreground">
                    {r.analysis.pipeline.historicalRowsLoaded} historical rows ·{" "}
                    {r.analysis.pipeline.homeSample} home-team observations ·{" "}
                    {r.analysis.pipeline.awaySample} away-team observations ·{" "}
