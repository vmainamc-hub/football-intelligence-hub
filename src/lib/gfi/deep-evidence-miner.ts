...
function safeRows(rows: MatchRow[]) {
...
function sourceFamily(source?: string) {
  ...
  if (value.includes("football-data")) return "results-database";
  if (value.includes("openfootball")) return "open-fixture-results";
  if (value.includes("sportsdb")) return "global-fixture-enrichment";
  if (value.includes("espn")) return "scoreboard-results";
  if (value.includes("sportscore")) return "fixture-team-discovery";
  if (value.includes("betika")) return "bookmaker-fixture-universe";
  if (value.includes("research")) return "public-research";
  return value;
}
